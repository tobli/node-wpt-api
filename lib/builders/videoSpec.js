...
module.exports = function VideoSpecBuilder(config = {}) {
  ...
  this.withTestId = id => new VideoSpecBuilder(assign(this._config, { id }));

  this.withRun = run => new VideoSpecBuilder(assign(this._config, { r: run }));

  this.withLabel = label =>
    new VideoSpecBuilder(assign(this._config, { l: label }));

  this.withStartSeconds = startSeconds =>
    new VideoSpecBuilder(assign(this._config, { i: startSeconds }));

  this.withEndSeconds = endSeconds =>
    new VideoSpecBuilder(assign(this._config, { e: endSeconds }));
