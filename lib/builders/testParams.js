...
module.exports = function TestParamsBuilder(config = {}) {
  ...
  this.withLocation = function(location) {
    return new TestParamsBuilder(assign(this._config, { location }));
  };

  this.withLabel = function(label) {
    return new TestParamsBuilder(assign(this._config, { label }));
  };

  this.withoutRepeatView = function() {
    return new TestParamsBuilder(assign(this._config, { fvonly: 1 }));
  };

  this.withVideoCapture = function() {
    return new TestParamsBuilder(assign(this._config, { video: 1 }));
  };

  this.withUserAgent = function(uastring) {
    return new TestParamsBuilder(assign(this._config, { uastring }));
  };
